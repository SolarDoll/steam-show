...
(function () {
  ...
  var DICT = {
    ...
    'hero.tag':     { en: 'We bring the fire, light & dragons.',
                      ru: 'Огонь, свет и драконы — под ваш формат.' },
    ...
    'prog.lead':    { en: 'Book a full show programme, or drop any act into go-mode (a live set that runs to your event flow or a DJ’s beat). Take one show, or stack several into a single night. Tap any block to open the show.',
                      ru: 'Закажите программу целиком или включите любой номер в свободный режим — живой сет под тайминг вашего мероприятия или бит диджея. Возьмите одно шоу или соберите несколько в один вечер. Нажмите на блок, чтобы открыть шоу.' },
    ...
    'howwe.lead':   { en: 'Five signature shows, ready to book and tour. We bring our own crew, costumes and equipment. For large-scale events we can also build something bespoke, on request.',
                      ru: 'Пять фирменных шоу, готовых к заказу. Приезжаем со своей командой, костюмами и оборудованием. Для крупных мероприятий можем собрать что-то уникальное под задачу.' },
    'howwe.1h':     { en: 'Made in-house', ru: 'Всё своими руками' },
    'howwe.1p':     { en: 'Every costume and prop is designed and built in our own workshop. Full control over quality and look.',
                      ru: 'Каждый костюм и реквизит придуман и собран в нашей мастерской. Полный контроль качества и вида.' },
    'howwe.2h':     { en: 'Adaptable', ru: 'Гибко под вас' },
    'howwe.2p':     { en: 'Each show flexes to your venue, theme, timing and audience, indoor or outdoor, tuned to your run of show.',
                      ru: 'Каждое шоу подстраивается под площадку, тему, тайминг и зрителя — в помещении или на улице, под сценарий вашего вечера.' },
    'howwe.3h':     { en: 'Custom on request', ru: 'Индивидуально под задачу' },
    'howwe.3p':     { en: 'For large-scale events we can develop costumes and concepts, an optional add-on, built to your brief.',
                      ru: 'Для крупных мероприятий разрабатываем костюмы и концепции — опциональная доработка под ваш бриф.' },
    'howwe.4h':     { en: 'Touring', ru: 'Гастроли' },
    'howwe.4p':     { en: 'We travel worldwide with our own crew and equipment, ready wherever the stage is.',
                      ru: 'Выезжаем со своей командой и оборудованием — по Беларуси, региону и за рубеж.' },

    /* -- секция форматов / география (бывш. Worldwide) -- */
    'world.kicker': { en: 'On tour', ru: 'Любой формат' },
    'world.big':    { en: 'We perform <span class="grad">anywhere</span>', ru: 'Под <span class="grad">любой</span> формат' },
    'world.lead':   { en: 'From intimate weddings to festival main stages: parades, grand openings, galas and corporate nights. If there’s a crowd, we light it up. Anywhere on the map.',
                      ru: 'Одно шоу подстроится под ваш формат: от камерной свадьбы до главной сцены фестиваля. Свадьбы, корпоративы, открытия, городские праздники, ТЦ и галасы — если есть зрители, мы зажжём.' },
    ...
    'world.formats': { en: ['Weddings','Corporate','Grand openings','Festivals','City events','Malls','Parades','Galas'],
                       ru: ['Свадьбы','Корпоративы','Открытия','Фестивали','Городские праздники','Торговые центры','Парады','Галасы'] },
    ...
    'contact.lead':   { en: 'Tell us the date, the venue and the vibe, and we’ll bring the fire. Or the light. Or the giants. Or all of it at once. You get the idea.',
                        ru: 'Расскажите дату, площадку и настроение — а огонь, свет и великанов привезём мы. Или всё сразу. Вы поняли идею.' },
